...
*  /todos.xml
*  /todos/done.xml
*  /todos/```<%= t('rest_help.id') %>```.xml
*  /tickler.xml
*  /hidden.xml
*  /calendar.xml
*  /contexts.xml
*  /contexts/<code><%= t('rest_help.id') %></code>.xml</li>
*  /contexts/<code><%= t('rest_help.id') %></code>/todos.xml</li>
*  /projects.xml</li>
*  /projects/```<%= t('rest_help.id') %>```.xml</li>
* /projects/```<%= t('rest_help.id') %>```/todos.xml</li>
